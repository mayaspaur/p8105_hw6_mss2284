...
are statistically significant. This is backward selection.
...
\#LEAPS library does this automatically, can use the function STEP.
...
\#how to get intercept and tmin in one row
...
```
    ...
    ## # A tibble: 20 x 8
    ## # Groups:   id [10]
    ##    id    results    std_error statistic   p_value intercept   tmin log_term
    ##    <chr> <list>         <dbl>     <dbl>     <dbl>     <dbl>  <dbl>    <dbl>
    ##  1 01    <tibble [~    0.223       33.5 5.02e-113      7.45 NA           NA
    ##  2 01    <tibble [~    0.0174      59.4 5.65e-189     NA     1.03        NA
    ##  3 02    <tibble [~    0.243       30.3 1.98e-101      7.36 NA           NA
    ##  4 02    <tibble [~    0.0185      55.9 2.12e-180     NA     1.03        NA
    ##  5 03    <tibble [~    0.215       34.8 8.29e-118      7.48 NA           NA
    ##  6 03    <tibble [~    0.0163      63.7 4.35e-199     NA     1.04        NA
    ##  7 04    <tibble [~    0.234       33.7 6.50e-114      7.91 NA           NA
    ##  8 04    <tibble [~    0.0176      56.8 1.37e-182     NA     0.998       NA
    ##  9 05    <tibble [~    0.243       27.7 1.69e- 91      6.73 NA           NA
    ## 10 05    <tibble [~    0.0173      61.9 5.73e-195     NA     1.07        NA
    ## 11 06    <tibble [~    0.221       31.1 1.42e-104      6.87 NA           NA
    ## 12 06    <tibble [~    0.0166      64.0 7.62e-200     NA     1.06        NA
    ## 13 07    <tibble [~    0.211       33.8 4.67e-114      7.11 NA           NA
    ## 14 07    <tibble [~    0.0162      63.9 1.37e-199     NA     1.03        NA
    ## 15 08    <tibble [~    0.219       32.5 1.24e-109      7.14 NA           NA
    ## 16 08    <tibble [~    0.0173      59.7 1.06e-189     NA     1.03        NA
    ## 17 09    <tibble [~    0.227       31.3 3.27e-105      7.10 NA           NA
    ## 18 09    <tibble [~    0.0166      63.0 1.61e-197     NA     1.05        NA
    ## 19 10    <tibble [~    0.223       32.2 1.62e-108      7.18 NA           NA
    ## 20 10    <tibble [~    0.0166      63.6 7.09e-199     NA     1.05        NA
