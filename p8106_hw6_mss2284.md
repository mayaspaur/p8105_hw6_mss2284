...
model-building process using backward selection, whereby variables that
are statistically significant remain the model.
...
![](p8106_hw6_mss2284_files/figure-gfm/unnamed-chunk-7-1.png)<!-- -->
